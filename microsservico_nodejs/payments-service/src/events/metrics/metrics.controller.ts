...
export class MetricsController {
  ...
  getHealth(): {
    ...
    // Verifica se está processando ( ativo nos ultimos 5 minutos )
    ...
    let message: string = 'Consumer is operating normally';
  ...
  resetMetrics(): { success: boolean; message: string } {
    ...
    this.logger.warn('Metrics were reset by API call');
