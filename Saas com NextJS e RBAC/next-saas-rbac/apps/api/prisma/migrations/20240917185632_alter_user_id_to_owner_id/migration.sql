/*
  ...
  - Added the required column `ownerId_id` to the `projects` table without a default value. This is not possible if the table is not empty.
...
ADD COLUMN     "ownerId_id" TEXT NOT NULL;

-- AddForeignKey
ALTER TABLE "organizations" ADD CONSTRAINT "organizations_owner_id_fkey" FOREIGN KEY ("owner_id") REFERENCES "users"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "projects" ADD CONSTRAINT "projects_ownerId_id_fkey" FOREIGN KEY ("ownerId_id") REFERENCES "users"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
